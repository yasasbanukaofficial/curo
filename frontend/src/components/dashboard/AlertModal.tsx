...
const buttonStyles: Record<AlertButtonVariant, string> = {
  primary:
    "h-9 px-4 text-sm font-medium text-white bg-[var(--accent)] dark:bg-white dark:text-[var(--accent)] rounded-[10px] hover:bg-[var(--accent)]/90 dark:hover:bg-[var(--accent)]/10 disabled:opacity-50 disabled:cursor-not-allowed",
  secondary:
