...
export function CheckIcon({ className = "h-4 w-4 mt-0.5 shrink-0 text-[#191919]" }: IconProps) {
  return (
...
export function CheckCircleIcon({ className = "h-7 w-7 text-emerald-600" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function WarningIcon({ className = "h-5 w-5 shrink-0 text-red-500" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function UploadIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 16V4m-4 4l4-4 4 4M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2" />
    </svg>
  );
}
