      ...
      <StaggerContainer className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8" margin="0px">
            ...
            <motion.div key={idx} variants={fadeInUp(20, 0.5)}>
              ...
              <ul className="space-y-3">
                {section.links.map((link, lIdx) => (
                  <li key={lIdx}>
                    <a href="#" className="text-sm text-black/70 dark:text-white/70 hover:text-black dark:hover:text-white transition-colors">{link}</a>
                  </li>
                ))}
              </ul>
            </motion.div>
        ...
        <motion.div variants={fadeInUp(20, 0.5)} className="border-t border-black/10 dark:border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors"><FacebookIcon /></a>
            <a href="#" className="text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors"><TwitterIcon /></a>
            <a href="#" className="text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors"><GitHubIcon /></a>
            <a href="#" className="text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors"><LinkedInIcon /></a>
          </div>
        </motion.div>
      </StaggerContainer>
    </footer>
