            ...
            <div className="xl:col-span-2 flex flex-col gap-6">
              ...
              <DashboardCard>
                <div className="flex items-center justify-between mb-5">
                  ...
                  <DashboardButton onClick={() => setShowInviteModal(true)} className="h-8 px-3 text-xs font-medium text-white bg-[var(--accent)] dark:bg-white dark:text-[#1D1D1F] rounded-[10px] hover:bg-[var(--accent)]/90 dark:hover:bg-[#E5E5E5]">
      ...
      {teamDetail || (
        <>
          <div className="flex items-center justify-between mb-6">
            ...
            <DashboardButton onClick={() => setShowCreateModal(true)} className="h-9 px-4 text-sm font-medium text-white bg-[var(--accent)] dark:bg-white dark:text-[#1D1D1F] rounded-[10px] hover:bg-[var(--accent)]/90 dark:hover:bg-[#E5E5E5]"><Plus className="w-4 h-4" />Create Team</DashboardButton>
          </div>
