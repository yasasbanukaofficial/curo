...
router.delete("/:projectId/secrets/:secretId", authenticate, validateProjectAccess, validateRole("owner", "admin", "developer"), deleteProjectSecret);

router.get("/:projectId/environments", authenticate, validateProjectAccess, getAllProjectEnvironments);
router.post("/:projectId/environments", authenticate, validateProjectAccess, validateRole("owner", "admin", "developer"), createProjectEnvironment);
router.put("/:projectId/environments/:environmentId", authenticate, validateProjectAccess, validateRole("owner", "admin", "developer"), updateProjectEnvironment);
router.delete("/:projectId/environments/:environmentId", authenticate, validateProjectAccess, validateRole("owner", "admin", "developer"), deleteProjectEnvironment);
