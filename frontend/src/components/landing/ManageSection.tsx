...
export default function ManageSection() {
  ...
  return (
    <section id="manage" className="relative bg-[#fcfcfc] scroll-mt-24">
      ...
      <div className="border-x border-[#efefef] mx-auto max-w-[1400px] px-8 sm:px-10 lg:px-14 py-16 lg:py-24 relative">
        ...
        <StaggerContainer className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          <motion.div variants={scaleFadeIn()} className="flex-1 max-w-lg">
            <div className="text-[#1D1D1F] text-xs uppercase font-bold tracking-widest mb-3">Manage</div>
          ...
          <motion.div variants={scaleFadeIn()}>
            <div className="bg-white w-full rounded-[16px] shadow-[0_20px_40px_rgba(0,0,0,0.08)] border border-[#E5E5EA] overflow-hidden">
                ...
                {secrets.map((secret, i) => (
                  ...
                  >
                    <div className="flex flex-col">
                      <span className="text-xs text-[#1D1D1F] font-medium">{secret.key}</span>
                      <motion.span
                    ...
                    <div className="flex items-center gap-2">
                      {["production", "v23", "encrypted"].map((badge, j) => (
                        <motion.span
                          key={j}
                          className="px-2 py-0.5 bg-[#F5F5F7] rounded text-[10px] text-[#6E6E73] font-sans font-medium cursor-default"
