...
export default function CentralizeSection() {
  ...
  const textColumn = (
    <motion.div variants={scaleFadeIn()} className="flex-1 max-w-lg order-1 lg:order-2">
      <div className="text-[#1D1D1F] dark:text-[#E5E5E5] text-xs uppercase font-bold tracking-widest mb-3">Centralize</div>
  ...
  if (reduced) {
    return (
      <section id="centralize" className="relative bg-[#fcfcfc] dark:bg-black scroll-mt-24 py-8 lg:py-12">
        <div className="border-x border-[#efefef] dark:border-[#222] mx-auto max-w-[1400px] px-8 sm:px-10 lg:px-14 py-16 lg:py-24 relative">
          ...
          <ParallaxDrift drift={3} className="flex-1 max-w-lg order-2 lg:order-1 flex justify-center">
            <div className="flex flex-col items-center w-full max-w-sm">
                {vaultCard}
                <h3 className="text-2xl md:text-3xl font-medium text-[#1D1D1F] dark:text-[#E5E5E5] tracking-tight mt-6">CURO</h3>
                <p className="text-sm text-[#6E6E73] dark:text-[#9A9A9A] mt-2">Secure Environment Variable Management</p>
              </div>
            </ParallaxDrift>
            {textColumn}
          </StaggerContainer>
  ...
  return (
    <section id="centralize" className="relative bg-[#fcfcfc] dark:bg-black scroll-mt-24">
      <div className="border-x border-[#efefef] dark:border-[#222] mx-auto max-w-[1400px] px-8 sm:px-10 lg:px-14 py-24 lg:py-32 relative">
        <Corner />
        <StaggerContainer className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          <motion.div variants={scaleFadeIn()} className="flex-1 max-w-lg order-2 lg:order-1 flex justify-center">
            ...
            >
              ...
              <motion.h3
                className="text-2xl md:text-3xl font-medium text-[#1D1D1F] dark:text-[#E5E5E5] tracking-tight mt-6"
                variants={{
              ...
              <motion.p
                className="text-sm text-[#6E6E73] dark:text-[#9A9A9A] mt-2"
                variants={{
                  hidden: { opacity: 0 },
